...
const SignUp = () => {
  ...
  useEffect(() => {
    setClientName("customer1");
    setEmail("customer1@gmail.com");
    setPassword("customer1");
    setChecked(true);
  }, []);
  ...
  const handleSignUp = (e) => {
    ...
    if (checked) {
      ...
      if (
        ...
        setSuccessMsg(
          `Hello dear ${clientName}, Welcome you to OFF !. We received your Sign up request. We are processing to validate your access. Till then stay connected and additional assistance will be sent to you by your mail at ${email}`
        );
        setClientName("");
        setEmail("");
        setPassword("");
            ...
            <div className="px-6 py-4 w-full h-[96%] flex flex-col justify-start overflow-y-scroll scrollbar-thin scrollbar-thumb-primeColor">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-.5">
                  <p className="font-titleFont text-base font-semibold text-gray-600">Name</p>
                  <input
                    onChange={handleName}
                    value={clientName}
                ...
                <div className="flex items-start mdl:items-center gap-2">
                  ...
                  <p className="text-sm text-primeColor">
                    I agree to the OFF <span className="text-blue-500">Terms of Service</span> and{" "}
